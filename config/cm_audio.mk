...
ALARM_PATH := vendor/brn/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/brn/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/brn/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/brn/prebuilt/common/media/audio/ui
